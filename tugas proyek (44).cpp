// TUGAS PROYEK 
// KELOMPOK 6
// 1.CHESSIE PAQUITA SANJAYA
// 2.RAHMA SARI SIREGAR
// 3.JOYA RAHMAWIDA
// 4.ZAFHIRA MUTIA ALIKAFITRI
//Berikut adalah contoh program CRUD sederhana untuk data komputer menggunakan bahasa pemrograman C++:
